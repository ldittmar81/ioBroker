...
function setup(callback) {
    ...
    if (fs.existsSync(path.join(rootDir, 'node_modules', 'iobroker', 'node_modules', 'iobroker.discovery'))) {
        fs.renameSync(path.join(rootDir, 'node_modules', 'iobroker', 'node_modules', 'iobroker.discovery'), path.join(rootDir, 'node_modules', 'iobroker.discovery'));
    }
    if (fs.existsSync(path.join(rootDir, 'node_modules', 'iobroker', 'node_modules', 'iobroker.admin'))) {
        fs.renameSync(path.join(rootDir, 'node_modules', 'iobroker', 'node_modules', 'iobroker.admin'), path.join(rootDir, 'node_modules', 'iobroker.admin'));
    }
    if (fs.existsSync(path.join(rootDir, 'node_modules', 'iobroker', 'node_modules', 'iobroker.js-controller'))) {
        fs.renameSync(path.join(rootDir, 'node_modules', 'iobroker', 'node_modules', 'iobroker.js-controller'), path.join(rootDir, 'node_modules', 'iobroker.js-controller'));
    }
